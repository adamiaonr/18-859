...
plot 'udp_0_5.stat.byte.dat' using ($2/n):xtic(1) ti col fc rgb w, '' u ($3/n) ti col fc rgb c, '' u ($4/n) ti col fc rgb a, (512000/n) ti 'File Size' with lines
